...
<header id="header-container" class="fullwidth" dir="ltr">
	<div id="header">
			<div class="container">
	            ...
	            <div class="col-md-4">
					...
					<nav id="navigation">
						<ul id="responsive">
							<!-- <li style="text-align: left;"><a href="{{route('home.about.us')}}">{{__('topbar.AboutUs')}}</a>
										<ul class="dropdown-nav">
										    <li style="text-align: left;"><a href="{{route('home.about.us')}}">{{__('topbar.AboutUs')}}</a>
											<li style="text-align: left;"><a href="{{route('home.contact')}}">{{__('topbar.ContactUs')}}</a></li>
							...
							<li style="text-align: left;"><a href="{{route('home.how')}}">{{__('topbar.how')}}</a>
							...
							<li style="text-align: left;"><a href="{{route('home.knowledge.hub')}}">{{__('topbar.Knowledge Hub')}}</a>
								
							</li>

							<li style="text-align: left;"><a href="{{route('happilancing')}}"> {{__('topbar.Happilancing')}}</a>
							...
							@if( Route::has('login'))
	            						@auth
	            						@else
							<li style="text-align: left;"><a href="{{route('login')}}">{{__('topbar.Login')}}</a></li>
							@endif
							@endif
								@if( Route::has('login'))
	            						@auth
	            						@else
							<li style="text-align: left;"><a href="{{route('register.create')}}"> {{__('topbar.Join Jamtalent')}}</a>	
							</li>
							@endif
							@endif
								...
								<div class="dropdown fon-lang-btn">
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
										<li>
											<form action="{{route('changeLang')}}" method="get">
												<input type="hidden" name="lang"value="ar">
												<button type="submit"  class="changeLang " style="color:black;"><img class="flag" src="{{asset('img/ar.png')}}" alt="" data-tippy-placement="top"> Arabic</button>
											</form>
										</li>
										<li>
											<form action="{{route('changeLang')}}" method="get">
												<input type="hidden" name="lang"value="en">
												<button type="submit"  class="changeLang " style="color:black;"><img class="flag" src="{{asset('img/en_US.png')}}" alt=""  data-tippy-placement="top"> English</button>
											</form>
										</li>
										<li>
											<form action="{{route('changeLang')}}" method="get">
						...
						<ul id="responsive">
							...
							@endif
								@if( Route::has('login'))
	            						@auth
	            						@else
							<li><a href="{{route('register.create')}}"> {{__('topbar.Join Jamtalent')}}</a>	
							</li>
							@endif
							@endif
							<li class="btn btn-primary"><a href="{{route('all.freelancer')}}" class="btn" style="color:white">{{__('topbar.Find Talent')}}</a>
...
@endif
  <!--end language button -->
@if(session()->get('locale') == 'ar')	
<div class="dropdown lang-button" style="margin-right: 10%!important;" dir="ltr">
	@else
	<div class="dropdown lang-button">
	@endif
  <button class="btn btn-se dropdown-toggle sidor" type="button" id="dropdownMenuButton"style="margin-right: -13%!important;" data-toggle="dropdown" aria-expanded="false" >

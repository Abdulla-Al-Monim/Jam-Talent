...
<div class="container">
	<div class="row">
		<div class="col-xl-8 col-lg-8 content-right-offset">
            ...
            <input type="hidden" name="rate" value="0">
			<!-- Hedaline -->
			<h3>{{__('checkoutConfirm.Billing Cycle')}}</h3>
			...
			<div class="billing-cycle margin-top-25">
				...
				<div class="radio">
					...
					<label for="radio-5">
						...
						{{__('checkoutConfirm.Billed Monthly')}}
				...
				<div class="radio">
					...
					<label for="radio-6"><span class="radio-label"></span>
						{{__('checkoutConfirm.First Month Free')}}
		...
		<div class="col-xl-4 col-lg-4 margin-top-0 margin-bottom-60">
			...
			<div class="boxed-widget summary margin-top-0">
				...
				<div class="boxed-widget-inner">
					<ul>
						<li>{{$membershipPlan->plan_name}} Plan <span>$0</span></li>
						<li>VAT (0%) <span>$0</span></li>
						<li class="total-costs">{{__('checkoutConfirm.Final Price')}} <span>$0</span></li>
					</ul>
				</div>
			</div>
			<!-- Summary / End -->

...
<div class="dashboard-content-container" data-simplebar>
		<div class="dashboard-content-inner" >
			...
			<div class="dashboard-headline">
				<h3 style="text-align:left;">{{__('addUser.Add Freelancer')}}</h3>
				...
				<nav id="breadcrumbs" class="dark">
					<ul>
						...
						<li>{{__('addUser.Add Freelancer')}}</li>
					</ul>
				</nav>
			</div>
			...
			<!-- Row -->
			<div class="row">
				<form method="POST" action="{{route('freelancer.store')}}" enctype="multipart/form-data">
					@csrf
					<!-- Dashboard Box -->
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0">
						...
						<!-- Headline -->
						<div class="headline">
							<h3><i class="icon-material-outline-account-circle"></i> {{__('addUser.Add Freelancer')}}</h3>
						</div>

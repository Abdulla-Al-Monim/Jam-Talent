...
<div class="dashboard-content-container" data-simplebar>
		...
		@if(Auth::user()->socialMedia)
			...
			@else
			<div class="row">
				<form method="POST" action="{{route('freelancer.social.media.create')}}" enctype="multipart/form-data">
					@csrf
					<!-- Dashboard Box -->
								...
								<div class="col">
									<div class="row">
										...
										<div class="col-xl-6">
											<div class="submit-field">
												<h5>{{__('backendIndex.Facebook')}}</h5>
												<input type="text" name="facebook" class="with-border" value="">
											</div>
										</div>
										...
										<div class="col-xl-6">
											<div class="submit-field">
												<h5>{{__('backendIndex.Git hub')}}</h5>
												<input type="text" class="with-border" value="" name="github">
											</div>
										</div>
										...
										<div class="col-xl-6">
											<div class="submit-field">
												<h5>{{__('backendIndex.Linked in')}}</h5>
												<input type="text" class="with-border" value="" name="linkedin">
											</div>
										</div>
										<div class="col-xl-6">
											<div class="submit-field">
												<h5>{{__('backendIndex.Google Plus')}}</h5>
												<input type="text" name="google_plus" class="with-border" value="">
											</div>
										</div>
										<div class="col-xl-6">
											<div class="submit-field">
												<h5>{{__('backendIndex.Twitter')}}</h5>
												<input type="text" class="with-border" value="" name="twitter">
											</div>
										</div>
										<div class="col-xl-6">
											<div class="submit-field">
												<h5>{{__('backendIndex.Instagram')}}</h5>
												<input type="text" class="with-border" value="" name="instagram">
											</div>
										</div>
									</div>
								</div>

									...
									<div class="freelancer-overview manage-candidates">
										<div class="freelancer-overview-inner">
											...
											@endphp
												...
												@endif
												<span class="freelancer-detail-item">{{__('backendOrder.Days')}}{{__('backendOrder.Budget')}} {{$order->budget}}$</span>
												<br>
												...
												<div class="buttons-to-right always-visible margin-top-25 margin-bottom-5">
													...
													<!-- Cancel Order -->
													<a href="#small-dialog-2{{$order->id}}" class="popup-with-zoom-anim button green ripple-effect"> {{__('backendOrder.Cancel Order')}}</a>
														...
														<div class="sign-in-form">
															...
															<div class="popup-tabs-container">
																...
																<div class="popup-tab-content" id="tab">
																		<!-- Form -->
																	<form method="POST" action="{{route('cancel.order.employer', $order->id)}}" enctype="multipart/form-data">
																		@csrf
